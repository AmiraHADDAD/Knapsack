    ...
    return (
        <div className="home h-screen w-screen flex flex-row border border-solid border-fuchsia-900">
            <div className="flex flex-col py-32 px-6 items-start justify-start w-[50%] relative">
                <h1 className="text-[#1A1A1D] text-5xl font-bold mb-10">
                ...
                <Link to="/solution"> 
                    <button
                        className="bg-neutral-50 text-[#1A1A1D] text-lg px-4 py-2 rounded-full hover:bg-neutral-100 transition absolute mt-16 right-8"
                    >
